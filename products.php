  ...
  if (empty($_SESSION["shopping_cart"])) {
    ...
    if (in_array($code, $array_keys)) {
      $status = "<div class='box' style='color:red; '>
		Product is already added to your cart! To add more view your cart at the top of the page</div>";
    } else {
  ...
  <div style="display:none;" id="myDiv" class="animate-bottom">
    ...
    <nav class="navbar navbar-expand-md nav-colour navbar-light sticky-top">
      ...
      <div>
        ...
        <div class="cart_div">
          <a href="cart.php">
            <p class='fa fa-shopping-cart fa-2x'></p> <span><?php echo $cart_count; ?></span>
          </a>
        </div>
        <?php
        }
    ...
    <div class='r'>
      ...
      $sql = "SELECT name, price, description, img, code FROM products";
